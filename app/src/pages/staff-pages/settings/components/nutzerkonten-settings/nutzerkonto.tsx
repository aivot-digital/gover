import {Box, Button, Card, Collapse, Divider, FormControlLabel, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Switch, Typography} from '@mui/material';
...
export function Nutzerkonto(props: PropsWithChildren<NutzerkontoProps>) {
    ...
    const handleToggle = (value: boolean) => {
        ...
        new SystemConfigsApiService(api)
            .update(props.configKey, {value: value ? 'true' : 'false'})
            .then((res) => {
