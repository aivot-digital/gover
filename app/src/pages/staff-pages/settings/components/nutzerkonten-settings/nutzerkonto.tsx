...
export function Nutzerkonto(props: PropsWithChildren<NutzerkontoProps>) {
    ...
    return (
        <>
            ...
            <ConfirmDialog
                title="Konto deaktiviern"
                onConfirm={confirmDisable}
                onCancel={() => setConfirmDisable(undefined)}
            >
                Sind Sie sicher, dass Sie dieses Konto wirklich deaktivieren wollen?<br />
                Wenn Sie dieses Konto deaktivieren, wird diese Option in allen aktuell entwickelten Formularen
                deaktiviert.<br />
                Sie können dieses Konto nur deaktivieren, wenn keine veröffentlichten Formulare dieses Konto verwenden.<br />
