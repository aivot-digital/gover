        ...
        useAssetsApi(api)
            ...
            .catch((err) => {
                if (err.stat === 406) {
                    ...
                    setUploadError('Die von Ihnen hochgeladene Datei ist zu groß. Probieren Sie eine andere Datei.');
                } else {
                    console.error(err);
    ...
    const handleSave = (): void => {
        if (editedAsset != null) {
            ...
            useAssetsApi(api)
                ...
                .catch((err) => {
                    if (err.stat === 406) {
                        dispatch(showErrorSnackbar('Der Dateinamen ist ungültig. Es sind nur Groß- und Kleinbuchstaben, Zahlen, Bindestriche, Unterstriche und Punkte erlaubt.'));
                    } else {
                        console.error(err);
    ...
    return (
        <>
            <FormPageWrapper
                ...
                onSave={originalAsset != null ? (isFilenameValid(editedAsset?.filename ?? '') ? handleSave : undefined) : handleSubmit}
...

                {
                    ...
                    <Box>
                        <TextFieldComponent
                            ...
                            hint="Der Dateiname wird als Titel des Dokuments / Medieninhalts verwendet. Es sind nur Groß- und Kleinbuchstaben, Zahlen, Bindestriche, Unterstriche und Punkte erlaubt."
                        />
