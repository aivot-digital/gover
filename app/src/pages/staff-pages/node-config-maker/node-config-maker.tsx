...
const ElementTypeBackendName: Record<ElementType, string> = {
    ...
    [ElementType.SecretSelectInput]: 'SecretSelectInput',
    [ElementType.AssetSelectInput]: 'AssetSelectInput',
    [ElementType.DepartmentSelectInput]: 'DepartmentSelectInput',
...
const ElementTypeBackendValueClass: Record<ElementType, string | null> = {
    ...
    [ElementType.DepartmentSelectInput]: 'Integer',
