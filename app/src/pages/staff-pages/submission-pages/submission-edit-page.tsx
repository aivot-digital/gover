...
import {AppToolbarPropsAction} from '../../../components/app-toolbar/app-toolbar-props';
...
export function SubmissionEditPage(): JSX.Element {
    ...
    const actions: AppToolbarPropsAction[] = [];
    if (archived == null) {
        actions.push({
        ...
        if (submission?.destinationId != null && !Boolean(submission?.destinationSuccess)) {
            actions.push({
