...
import DeleteOutline from '@aivot/mui-material-symbols-400-n25-outlined/Delete';
...
import AccountCircleOutlined from '@aivot/mui-material-symbols-400-n25-outlined/AccountCircle';
