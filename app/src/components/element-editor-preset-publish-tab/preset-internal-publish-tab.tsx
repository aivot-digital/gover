...
export function PresetInternalPublishTab(props: TabProps<GroupLayout, PresetVersion>): JSX.Element {
    ...
    const handlePublish = (): void => {
        usePresetsApi(api)
            .updateVersion(props.preset.key, {
                ...props.entity,
                root: props.element,
            ...
            .then((res) => {
                ...
                // TODO: Change saving logic to circumvent the need to hit the save button to update the main entity and element. Maybe via a flag to pass the direct save trough.
