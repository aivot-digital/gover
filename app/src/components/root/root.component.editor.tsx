    ...
    return (
        <>
            ...
            <TextFieldComponent
                ...
                label="Titel des Formulars im Browser-Tabs"
                hint="Dieser Titel (oftmals eine Kurzform) erscheint als Bezeichnung des Formulars im Tab des Webbrowsers. Wenn Sie keinen spezifischen Titel angeben, wir die Überschrift des Formulars verwendet."
                onChange={(val) => {
                    props.onPatch({
                        tabTitle: val,
                    });
