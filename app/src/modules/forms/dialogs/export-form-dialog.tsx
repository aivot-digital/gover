...
interface ExportFormDialogProps extends DialogProps {
    open: boolean;
    onCancel: () => void;
    onExport: () => void;
}

export function ExportFormDialog({open, onCancel, onExport}: ExportFormDialogProps) {
    return (
        <Dialog
            open={open}
            onClose={onCancel}
        ...
        >
            ...
            <DialogContent id="export-dialog-description">
                ...
                <DialogContentText sx={{mt: 2}}>
                    ...
                    Dazu zählen u. a. Formular-ID, Schnittstellen, Status, Organisationseinheiten, rechtliche Hinweise, Support-Angaben, PDF-Vorlagen, Erscheinungsbilder, Zahlungsdetails, Test-Protokolle und die Historie.
                </DialogContentText>
                <DialogContentText sx={{mt: 2}}>
            ...
            <DialogActions>
                <Button
                    ...
                    autoFocus
                >
                    Formular als .json-Datei herunterladen
                </Button>
                <Button
                    onClick={onCancel}
                    color="inherit"
