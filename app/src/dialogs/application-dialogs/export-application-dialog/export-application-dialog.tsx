        ...
        >
            ...
            <DialogContent id="export-dialog-description">
                ...
                <DialogContentText sx={{ mt: 2 }}>
                    ...
                    Dazu zählen u. a. Formular-ID, Schnittstellen, Status, Fachbereiche, rechtliche Hinweise, Support-Angaben, PDF-Vorlagen, Farbschema, Zahlungsdetails sowie Test-Protokolle.
                </DialogContentText>
                <DialogContentText sx={{ mt: 2 }}>
