...
export function PublishPresetDialog(props: PublishPresetDialogProps): JSX.Element {
    ...
    const handleSubmit = (event: FormEvent) => {
        ...
        if (preset?.root != null && version != null && title != null && description != null && descriptionShort != null) {
            withTimeout(
                () => {
