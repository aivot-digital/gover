...
} from '../models/elements/form/input/process-attachment-name-chip-input-element';
import {hasDerivableAspects} from '../utils/has-derivable-aspects';
import {ChipInputFieldComponent} from '../components/chip-input-field/chip-input-field-component';

export function ProcessAttachmentNameChipInputFieldView(props: BaseViewProps<ProcessAttachmentNameChipInputElement, string[]>) {
    const {
        element,
        setValue,
        value,
