...
public class TextInputElement extends BaseInputElement<String> implements PrintableElement<String> {
    ...
    public TextInputElement setPlaceholder(@Nullable String placeholder) {
    ...
    public TextInputElement setAutocomplete(@Nullable String autocomplete) {
    ...
    public TextInputElement setIsMultiline(@Nullable Boolean multiline) {
    ...
    public TextInputElement setMaxCharacters(@Nullable Integer maxCharacters) {
    ...
    public TextInputElement setSuggestions(@Nullable List<String> suggestions) {
