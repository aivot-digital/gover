 ...
 */
@Service
public class ElementDerivationServiceV2 {
    ...
    @Autowired
    public ElementDerivationServiceV2(
    ...
    @Nonnull
    public DerivedRuntimeElementData derive(@Nonnull ElementDerivationRequestV2 request,
    ...
    private ElementData createAccumulator(@Nonnull BaseElement rootElement,
                                          @Nonnull String elementId,
                                          @Nonnull AuthoredElementValues authoredElementValues,
                                          @Nonnull EffectiveElementValues effectiveElementValues,
                                          @Nonnull ComputedElementStates computedElementStates) {
        return ElementData.fromValueMap(
                rootElement,
                authoredElementValues
        );
    }
