...
public interface SubmissionRepository extends JpaRepository<Submission, String> {
    ...
    @Transactional(readOnly = true)
    Collection<Submission> findAllByApplicationIdAndArchivedIsNullAndAssigneeId(Integer applicationId, Integer assigneeId);
    @Transactional(readOnly = true)
    Collection<Submission> findAllByApplicationId(Integer applicationId);
    @Transactional(readOnly = true)
    Collection<Submission> findAllByApplicationIdAndAssigneeId(Integer applicationId, Integer assigneeId);
}
