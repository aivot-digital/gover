...
public class ConditionSet {
    ...
    public String evaluate(String idPrefix, RootElement root, Map<String, Object> customerInput, ScriptEngine scriptEngine) {
        return switch (operator) {
            case All -> evaluateAll(idPrefix, root, customerInput, scriptEngine);
            case Any -> evaluateAny(idPrefix, root, customerInput, scriptEngine);
        };
    }
     ...
     */
    private String evaluateAll(String idPrefix, RootElement root, Map<String, Object> customerInput, ScriptEngine scriptEngine) {
        if (conditions != null) {
            for (var condition : conditions) {
                var conditionResult = condition.evaluate(idPrefix, root, customerInput, scriptEngine);
        ...
        if (conditionsSets != null) {
            for (var conditionSet : conditionsSets) {
                var conditionSerResult = conditionSet.evaluate(idPrefix, root, customerInput, scriptEngine);
     ...
     */
    private String evaluateAny(String idPrefix, RootElement root, Map<String, Object> customerInput, ScriptEngine scriptEngine) {
        if (conditions != null) {
            for (var condition : conditions) {
                var conditionResult = condition.evaluate(idPrefix, root, customerInput, scriptEngine);
                if (conditionResult == null) {
        ...
        if (conditionsSets != null) {
            for (var conditionSet : conditionsSets) {
                var conditionSetResult = conditionSet.evaluate(idPrefix, root, customerInput, scriptEngine);
