...
public interface ProcessNodeProvider {
     ...
     */
    @Nonnull
    default GroupLayout getConfigurationLayout(
    ...
    /**
     * Check if the user can get the task view layout for this node.
     *
     * @param user            The user requesting the layout. If null, the request is unauthenticated.
     * @param thisNode        The node entity for which the layout is requested.
     ...
     * @return True if the user can get the layout, false otherwise.
     * @throws ResponseException If an error occurs while checking permissions.
     */
    default boolean canGetTaskViewLayout(@Nullable UserEntity user,
                                         @Nonnull ProcessDefinitionNodeEntity thisNode,
    ...
    /**
     * Get the task view layout for nodes of this provider type.
     *
     * @param user            The user requesting the layout. If null, the request is unauthenticated.
     * @param thisNode        The node entity for which the layout is requested.
     * @param processInstance The process instance the task belongs to.
     ...
     */
    @Nonnull
    default GroupLayout getTaskViewLayout(
     ...
     *
     * @param user            The user requesting the events. If null, the request is unauthenticated.
     ...
     */
    @Nonnull
    default List<TaskViewEvent> getTaskViewEvents(
            @Nullable UserEntity user,
            @Nonnull ProcessDefinitionNodeEntity thisNode,
            @Nonnull ProcessInstanceEntity processInstance,
            @Nonnull ProcessInstanceTaskEntity thisTask
     ...
     */
    ProcessNodeExecutionResult init(
            @Nonnull ProcessInstanceEntity processInstance,
            @Nonnull ProcessDefinitionNodeEntity thisNode,
     ...
     * @throws Exception If an error occurs during execution.
     */
    default Optional<ProcessNodeExecutionResult> update(
            @Nullable UserEntity user,
            @Nonnull ProcessInstanceEntity processInstance,
            @Nonnull ProcessDefinitionNodeEntity thisNode,
            @Nonnull Map<String, Object> data,
