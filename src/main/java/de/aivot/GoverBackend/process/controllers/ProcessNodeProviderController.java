...
@RestController
@RequestMapping("/api/process-node-providers/")
@Tag(
...
public class ProcessNodeProviderController {
    ...
    public ProcessNodeProviderController(ProcessNodeProviderService processNodeProviderService) {
    ...
    public List<ProcessNodeProvider> list() throws ResponseException {
        return processNodeProviderService
                .getAllProcessNodeProviders();
    }
}
