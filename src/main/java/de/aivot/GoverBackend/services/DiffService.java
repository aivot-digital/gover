...
public class DiffService {
    ...
    private static List<DiffItem> createDiff(Object oldObject, Object newObject, String currentPath) {
        ...
        switch (targetObject) {
            ...
            case JSONArray jsonArray:
                ...
                if (remainingPath.size() == 1) {
                    ...
                    var jsonArrayChildToChange = jsonArray.getJSONObject(jsonArrayIndex);
