...
public class DestinationSubmitService {
    ...
    public DestinationSubmitService(
            ...
            PdfService pdfService, SubmissionAttachmentRepository submissionAttachmentRepository) {
    ...
    public void handleSubmit(Destination destination, Form form, Submission submission, Collection<SubmissionAttachment> attachments) {
        // Send to destination
    ...
    private DestinationResponse sendHttp(Destination destination, Form form, Submission submission, Collection<SubmissionAttachment> attachments) {
        ...
        Map<String, Object> destinationData = DestinationDataFormatter
                .create(form, submission, pdfBytes, attachmentBytes)
                .format();
