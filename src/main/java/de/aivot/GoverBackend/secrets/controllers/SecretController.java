...
public class SecretController {
    ...
    public SecretEntityResponseDTO create(
        ...
        auditService.addAuditEntry(de.aivot.GoverBackend.audit.models.AuditLogPayload.create().withUser(user).withAuditAction(AuditAction.Create, this.getClass().getSimpleName(), SecretEntity.class, "legacy", "legacy", Map.of("key", result.getKey())));
    ...
    public SecretEntityResponseDTO update(
        ...
        auditService.addAuditEntry(de.aivot.GoverBackend.audit.models.AuditLogPayload.create().withUser(user).withAuditAction(AuditAction.Update, this.getClass().getSimpleName(), SecretEntity.class, "legacy", "legacy", Map.of("key", result.getKey())));
    ...
    public void delete(
        ...
        auditService.addAuditEntry(de.aivot.GoverBackend.audit.models.AuditLogPayload.create().withUser(user).withAuditAction(AuditAction.Delete, this.getClass().getSimpleName(), SecretEntity.class, "legacy", "legacy", Map.of(
                "key", key,
                "name", entity.getName(),
