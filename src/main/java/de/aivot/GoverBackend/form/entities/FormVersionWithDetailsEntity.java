...
public class FormVersionWithDetailsEntity implements Cloneable {
    ...
    public static FormVersionWithDetailsEntity of(FormEntity form, FormVersionEntity version) {
        return new FormVersionWithDetailsEntity(
                ...
                version.getManagingOrganizationalUnitId(),
                version.getResponsibleOrganizationalUnitId(),
                ...
                version.getStatus(),
                version.getType(),
                version.getLegalSupportOrganizationalUnitId(),
                version.getTechnicalSupportOrganizationalUnitId(),
                version.getImprintOrganizationalUnitId(),
                version.getPrivacyOrganizationalUnitId(),
                version.getAccessibilityOrganizationalUnitId(),
