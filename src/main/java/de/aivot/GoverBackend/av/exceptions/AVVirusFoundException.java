...
public class AVVirusFoundException extends ResponseException {
    public AVVirusFoundException(String filename) {
        super(
                ...
                "In der hochgeladenen Datei wurde Schadsoftware erkannt. Der Upload wurde aus Sicherheitsgründen blockiert. Bitte bereinigen oder ersetzen Sie die Datei und laden Sie sie erneut hoch. Bei Rückfragen wenden Sie sich an den technischen Support.",
