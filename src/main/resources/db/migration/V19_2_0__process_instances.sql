...
(
    ...
    -- This is generated by the case number template of the process version when the process instance is started.
    -- If no case number template is defined, a random UUID is generated as case number.
