...
values (gen_random_uuid(),
        'sh_id',
        3,
        'Servicekonto Schleswig-Holstein (Vorproduktion)',
        'Konfiguration für die Vorproduktionsumgebung des Servicekonto Schleswig-Holstein.',
        null,
