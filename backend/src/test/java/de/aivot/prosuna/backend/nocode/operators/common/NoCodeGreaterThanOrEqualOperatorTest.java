package de.aivot.prosuna.backend.nocode.operators.common;

import de.aivot.prosuna.backend.plugins.core.v1.operators.common.NoCodeGreaterThanOrEqualOperator;
