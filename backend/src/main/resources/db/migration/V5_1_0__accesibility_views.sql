-- create a combined view of users and department memberships
create or replace view memberships_with_users as
select distinct mems.id,
                mems.department_id,
                mems.role,
                usrs.id             as user_id,
...
from department_memberships as mems
         join users as usrs
...
select subs.id,
       ...
       fms.bund_id_enabled                                         as form_bund_id_enabled,
       fms.bund_id_level                                           as form_bund_id_level,
       fms.bayern_id_enabled                                       as form_bayern_id_enabled,
       fms.bayern_id_level                                         as form_bayern_id_level,
       fms.muk_enabled                                             as form_muk_enabled,
       fms.muk_level                                               as form_muk_level,
       fms.sh_id_enabled                                           as form_sh_id_enabled,
       fms.sh_id_level                                             as form_sh_id_level,
