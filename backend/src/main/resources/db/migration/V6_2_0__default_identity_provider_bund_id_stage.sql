...
values (gen_random_uuid(),
        'bund_id',
        2,
        'BundID (Vorproduktion)',
        'Konfiguration für die Vorproduktionsumgebung der BundID.',
        null,
        ...
        '[
            ...
            {
                "label": "Postfach",
                "description": "Technischer Postkorb-Handle (UUID) zum Zustellen von BundID-Nachrichten.",
