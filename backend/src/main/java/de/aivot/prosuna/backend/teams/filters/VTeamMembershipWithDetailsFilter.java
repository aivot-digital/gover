package de.aivot.prosuna.backend.teams.filters;
...
public class VTeamMembershipWithDetailsFilter implements Filter<VTeamMembershipWithDetailsEntity> {
    ...
    public Integer getDomainRoleId() {
        return domainRoleId;
    }

    public VTeamMembershipWithDetailsFilter setDomainRoleId(Integer domainRoleId) {
