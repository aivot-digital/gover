...
public final class IdentityQueryParameterConstants {
    ...
    public static final String AUTH_ENDPOINT_RESPONSE_TYPE = "response_type";
    ...
    public static final String REMOTE_AUTH_ERROR = "error";
    public static final String REMOTE_AUTH_ERROR_DESCRIPTION = "error_description";
}
