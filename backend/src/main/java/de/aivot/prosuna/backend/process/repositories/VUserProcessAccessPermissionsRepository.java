...
import de.aivot.prosuna.backend.process.entities.VUserProcessAccessPermissionsEntity;
import de.aivot.prosuna.backend.process.entities.VUserProcessAccessPermissionsEntityId;
