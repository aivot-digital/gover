 ...
 * Instantiate a new {@link de.aivot.prosuna.backend.javascript.services.JavascriptEngine} with the {@link de.aivot.prosuna.backend.javascript.services.JavascriptEngineFactoryService} and call the evaluate method with the javascript code as a string.
 ...
 * A function provider should implement the interface {@link de.aivot.prosuna.backend.javascript.providers.JavascriptFunctionProvider}.
 ...
 */
package de.aivot.prosuna.backend.javascript;