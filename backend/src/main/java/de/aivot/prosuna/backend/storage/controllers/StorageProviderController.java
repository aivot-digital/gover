...
import de.aivot.prosuna.backend.storage.entities.StorageIndexItemEntity;
...
import de.aivot.prosuna.backend.storage.repositories.StorageIndexItemRepository;
import de.aivot.prosuna.backend.storage.services.StorageProviderConfigurationService;
import de.aivot.prosuna.backend.storage.services.StorageProviderDefinitionService;
import de.aivot.prosuna.backend.storage.services.StorageProviderService;
import de.aivot.prosuna.backend.storage.services.StorageService;
import de.aivot.prosuna.backend.storage.services.StorageSyncWorker;
...
public class StorageProviderController {
    ...
    private <T> void testConnection(StorageProviderEntity provider, StorageProviderDefinition<T> definition, boolean writable) throws StorageException {
        T config;
