package de.aivot.prosuna.backend.search.controllers;
...
import de.aivot.prosuna.backend.search.services.SearchItemService;
import de.aivot.prosuna.backend.search.services.SearchRecentItemService;
