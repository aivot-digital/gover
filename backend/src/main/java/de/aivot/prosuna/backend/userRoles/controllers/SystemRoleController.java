package de.aivot.prosuna.backend.userRoles.controllers;
...
import de.aivot.prosuna.backend.userRoles.dtos.DeleteSystemRoleResponseDto;
import de.aivot.prosuna.backend.userRoles.entities.SystemRoleEntity;
import de.aivot.prosuna.backend.userRoles.filters.SystemRoleFilter;
import de.aivot.prosuna.backend.userRoles.permissions.SystemRolePermissionProvider;
import de.aivot.prosuna.backend.userRoles.services.SystemRoleService;
...
public class SystemRoleController {
    ...
    public Page<SystemRoleEntity> list(
        ...
        permissionService
                .requireSystemPermission(execUser.getId(), SystemRolePermissionProvider.SYSTEM_ROLE_READ);
    ...
    public SystemRoleEntity create(
        ...
        permissionService
                .requireSystemPermission(execUser.getId(), SystemRolePermissionProvider.SYSTEM_ROLE_CREATE);
