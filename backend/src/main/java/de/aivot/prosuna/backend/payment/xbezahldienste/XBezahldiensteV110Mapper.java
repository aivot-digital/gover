...
import de.aivot.prosuna.backend.xbezahldienste.v1_1_0.Address;
import de.aivot.prosuna.backend.xbezahldienste.v1_1_0.Requestor;

import java.time.ZoneOffset;

public final class XBezahldiensteV110Mapper {
    private XBezahldiensteV110Mapper() {
    }

    public static de.aivot.prosuna.backend.xbezahldienste.v1_1_0.PaymentRequest toExternal(
            de.aivot.prosuna.backend.payment.models.PaymentRequest source
    ) {
        var target = new de.aivot.prosuna.backend.xbezahldienste.v1_1_0.PaymentRequest();
        ...
        target.setItems(source.items().stream().map(XBezahldiensteV110Mapper::toExternal).toList());
        target.setRequestor(toExternal(source.requestor()));
        return target;
    }

    public static PaymentInformation toDomain(
            de.aivot.prosuna.backend.xbezahldienste.v1_1_0.PaymentInformation source
        ...
        try {
            ...
            throw new PaymentException(e, "Invalid XBezahldienste 1.1.0 payment information");
        }
    }

    private static de.aivot.prosuna.backend.xbezahldienste.v1_1_0.PaymentItem toExternal(PaymentRequestItem source) {
        var target = new de.aivot.prosuna.backend.xbezahldienste.v1_1_0.PaymentItem();
    ...
    private static PaymentStatus toDomain(
            de.aivot.prosuna.backend.xbezahldienste.v1_1_0.PaymentInformation.StatusEnum status
    ) {
