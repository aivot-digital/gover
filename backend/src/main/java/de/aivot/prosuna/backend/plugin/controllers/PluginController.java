package de.aivot.prosuna.backend.plugin.controllers;
...
import de.aivot.prosuna.backend.plugin.dtos.PluginComponentDTO;
import de.aivot.prosuna.backend.plugin.dtos.PluginDTO;
import de.aivot.prosuna.backend.plugin.models.Plugin;
import de.aivot.prosuna.backend.plugin.models.PluginComponent;
import de.aivot.prosuna.backend.plugin.permissions.PluginPermissionProvider;
