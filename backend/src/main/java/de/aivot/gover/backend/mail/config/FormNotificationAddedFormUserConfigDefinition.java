...
@Component
public class FormNotificationAddedFormUserConfigDefinition implements UserConfigDefinition {
    public static final String KEY = "mail.notification.form.added";
    ...
    public String getLabel() {
        return "Neues Formular angelegt";
    }
