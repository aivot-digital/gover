package de.aivot.gover.backend.mail.config;

import de.aivot.gover.backend.config.enums.ConfigType;
import de.aivot.gover.backend.config.models.ConfigDefinitionOption;
...
@Component
public class SubmissionNotificationPaymentFailedUserConfigDefinition implements UserConfigDefinition {
    public static final String KEY = "mail.notification.submission.payment";
    ...
    public String getLabel() {
        return "Fehlermeldungen bei Abwicklung einer Zahlung mit einem Zahlungsdienstleister";
    }
