package de.aivot.gover.backend.config.services;

import de.aivot.gover.backend.config.entities.UserConfigEntity;
import de.aivot.gover.backend.config.entities.UserConfigEntityId;
...
import de.aivot.gover.backend.config.repositories.UserConfigRepository;
