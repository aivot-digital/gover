...
@Component
public class SubmissionNotificationReceivedUserConfigDefinition implements UserConfigDefinition {
    public static final String KEY = "mail.notification.submission.received";
    ...
    public String getLabel() {
        return "Neuer Antrag eingegangen";
    }
