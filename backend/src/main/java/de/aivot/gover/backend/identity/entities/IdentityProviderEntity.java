package de.aivot.gover.backend.identity.entities;

import de.aivot.gover.backend.identity.converters.IdentityAdditionalParametersConverter;
import de.aivot.gover.backend.identity.converters.IdentityAttributesConverter;
import de.aivot.gover.backend.identity.converters.IdentityScopesConverter;
import de.aivot.gover.backend.identity.enums.IdentityProviderType;
import de.aivot.gover.backend.identity.models.IdentityAdditionalParameter;
