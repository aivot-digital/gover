...
@Component
public class DepartmentNotificationMembershipAddedUserConfigDefinition implements UserConfigDefinition {
    public static final String KEY = "mail.notification.department.membership-added";
