...
import de.aivot.gover.backend.asset.dtos.AssetCreateRequestDTO;
import de.aivot.gover.backend.asset.dtos.AssetMoveRequestDTO;
import de.aivot.gover.backend.asset.dtos.AssetRequestDTO;
import de.aivot.gover.backend.asset.entities.AssetEntity;
import de.aivot.gover.backend.asset.entities.VStorageIndexItemWithAssetEntity;
import de.aivot.gover.backend.asset.entities.VStorageIndexItemWithAssetEntityId;
import de.aivot.gover.backend.asset.permissions.AssetPermissionProvider;
...
import de.aivot.gover.backend.asset.services.VStorageIndexItemWithAssetService;
...
public class AssetController {
    ...
    public StorageFolder createFolder(
        ...
        permissionService
                .hasSystemPermission(execUser.getId(), AssetPermissionProvider.ASSET_CREATE);
    ...
    public void deleteFolder(
        ...
        permissionService
                .hasSystemPermission(execUser.getId(), AssetPermissionProvider.ASSET_DELETE);
    ...
    public VStorageIndexItemWithAssetEntity updateFile(
        ...
        permissionService
                .hasSystemPermission(jwt, AssetPermissionProvider.ASSET_UPDATE);
    ...
    public VStorageIndexItemWithAssetEntity updateFileMetadata(
        ...
        permissionService
                .hasSystemPermission(execUser.getId(), AssetPermissionProvider.ASSET_UPDATE);
    ...
    public void deleteFile(
        ...
        permissionService
                .hasSystemPermission(user.getId(), AssetPermissionProvider.ASSET_DELETE);
