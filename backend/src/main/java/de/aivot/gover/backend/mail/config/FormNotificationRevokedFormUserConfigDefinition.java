...
@Component
public class FormNotificationRevokedFormUserConfigDefinition implements UserConfigDefinition {
    public static final String KEY = "mail.notification.form.revoked";
