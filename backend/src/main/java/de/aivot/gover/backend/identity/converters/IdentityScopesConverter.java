package de.aivot.gover.backend.identity.converters;
 ...
 * <ul>
 *     <li>Converts a list of {@link String} objects into a JSON string for storage in the database.</li>
 *     <li>Converts a JSON string from the database back into a list of {@link String} objects.</li>
 *     <li>Uses Jackson's {@link com.fasterxml.jackson.databind.ObjectMapper} for JSON serialization and deserialization.</li>
 *     <li>Handles exceptions during the conversion process by throwing a {@link RuntimeException}.</li>
 * </ul>
 *
