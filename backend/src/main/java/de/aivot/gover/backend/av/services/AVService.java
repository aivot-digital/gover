package de.aivot.gover.backend.av.services;

import de.aivot.gover.backend.av.exceptions.AVCheckFailedException;
import de.aivot.gover.backend.av.exceptions.AVVirusFoundException;
import de.aivot.gover.backend.lib.exceptions.ResponseException;
import de.aivot.gover.backend.models.config.ClamConfig;
