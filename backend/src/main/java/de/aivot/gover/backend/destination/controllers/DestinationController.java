package de.aivot.gover.backend.destination.controllers;
...
import de.aivot.gover.backend.destination.dtos.DestinationRequestDTO;
import de.aivot.gover.backend.destination.dtos.DestinationResponseDTO;
import de.aivot.gover.backend.destination.entities.Destination;
import de.aivot.gover.backend.destination.filters.DestinationFilter;
